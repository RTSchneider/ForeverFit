...
public class MainActivity extends AppCompatActivity {
    ...
    public void getScore(View view) {
        ...
        */
        ...
        if (Question_11_answer.getText().toString().toUpperCase().equals("Nutrition")
                || (Question_11_answer.getText().toString().toUpperCase().equals("food")))
        {
            score++;
        }
        if(Question_11_answer.getText().toString().toUpperCase().equals(""))
        {
            allAnswered = false;
        }
        if(!allAnswered)
